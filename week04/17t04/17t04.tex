...
\end{example}
\begin{solution*}
	Let A be one of the six people. Following from the generalized pigeonhole principle, of the five other people in the group, there are either three or more who are friends or enemies of A.
	
	Without loss of generality, suppose that B, C, and D are friends of A. If any two of these three individuals are friends, then these two and A form a group of three mutual friends. Otherwise, B, C, and D form a set of three mutual enemies.
\end{solution*}
\end{frame}
...
\begin{definition}
	The \textbf{Ramsey number} $R(m, n)$, where $m$ and $n$ are positive integers greater than or equal
	to 2, denotes the minimum number of people at a party such that there are either $m$ mutual friends or $n$ mutual enemies, assuming that every pair of people at the party are friends or enemies.
\end{definition}
\begin{example}
