...
\begin{frame}[fragile]
	\frametitle{Circuit}
	\begin{example}
		Let $P_1$ and $P_2$ be two simple paths between the vertices $u$ and $v$ in the simple graph $G$ that do not contain the same set of edges. Show that there is a simple circuit in $G$.
	\end{example}
	\begin{proof}
