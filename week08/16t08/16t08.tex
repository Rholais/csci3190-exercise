...
\begin{frame}[allowframebreaks]
	...
	\begin{theorem}
		...
		\end{enumerate}
	\end{theorem}
	\textbf{Proof.} The three parts of the theorem can all be proved using the equality given in Theorem \ref{t-11-1-3}, that is, $n = m i + 1$, together with the equality $n = l + i$, which is true because each vertex is either a leaf or an internal vertex. 
